...
| T5 | Trend auf Anlageklassen-ETFs mit Regimefilter und Rang hält die Marktrendite bei kleinerem Drawdown — die Kante liegt in der Breite über unkorrelierte Märkte, nicht in der Titelwahl. | offen (V1 verfehlt B4; Prüfer: V1 konnte T5 nicht bestätigen) | Probe #36: MaxDD 9,7 % gegen 24,1 % (B3 ✔, aber strukturell nicht verfehlbar), Sharpe 0,49 gegen 0,63 (B2 ✔ knapp, Marge unter der Streuung), Netto +14,2 % (B1 ✔); Gebührenanteil 67 % realisiert und 0,6 Trades je Monat (B4 ✘). Prüfbefund `pruefungen/2026-09-09-redteam-basis-v1.md` | Nicht einsetzen. V2: Kriterien im Code, durchgehende Simulation statt 90-Tage-Folds, Korb liegenlassen als Latte, Ausschüttungen in den Bars, Universum nach Regel (9 ETFs). |
