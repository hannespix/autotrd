...
import { DEFAULT_MAINTENANCE_MARGIN, MAX_LEVERAGE } from './margin.ts';
import { MIN_EDGE_MULTIPLE } from './costGate.ts';
import { MAX_OPEN_POSITIONS_CAP, type Strategy } from './strategy.ts';
import { MAX_PER_CLUSTER, correlationCluster, tradableSymbols } from './universe.ts';
